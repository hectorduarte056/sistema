              ...
              <div class="box">
                ...
                <div class="form-group row nuevoProducto">
                  ...
                  <div class="col-xs-3" style="padding-left:0px">
                    ...
                    <input type="number" min="1" class="form-control" id="nuevaPrecioProducto" name="nuevaPrecioProducto"  placeholder="00000" readonly required>
                        ...
                        <tr>
                          ...
                          <td style="width: 50%">
                            ...
                            <div class="input-group">
                              ...
                              <input type="number" class="form-control" min="0" id="nuevoImpuestoVenta" name="nuevoImpuestoVenta" placeholder="0" readonly required>
