      ...
      <div class="col-lg-5 col-xs-12">
        ...
        <div class="box-body">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" id="nuevoComprobanteCompra" name="nuevoComprobanteCompra" placeholder="Ingresar numero de compra" required>
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" id="nuevoNFC"  name="nuevoNFC" placeholder="Numero de comprobante fiscal" data-inputmask="'mask':'9999999999'" data-mask  required>
                        ...
                        <tr>
                          ...
                          <td style="width: 50%">
                            ...
                            <div class="input-group">
                              ...
                              <input type="number" class="form-control input-lg" min="0" id="nuevoImpuestoVenta" name="nuevoImpuestoVenta" placeholder="0" value="0" readonly required>
