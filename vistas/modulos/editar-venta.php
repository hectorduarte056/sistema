        ...
        <div class="box-body">
              ...
              <div class="box">
               ...
               <?php
                ...
                $itemComprobante = "id";
                $valorComprobante = $venta["id_comprobante"];

                $Comprobante = ControladorComprobantes::ctrMostrarComprobantes($itemComprobante, $valorComprobante);
                ...
                <div class="input-group">
                  ...
                  <select class="form-control input" id="nuevoComprobante" name="nuevoComprobante" required>

                  <option value="<?php echo $Comprobante["id"]; ?>"><?php echo $Comprobante["comprobante"]; ?></option>
...
<!--                 <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="nuevoNFC" name="nuevoNFC" value="<?php echo $venta["ncf"]; ?>" readonly>
