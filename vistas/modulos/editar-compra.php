        ...
        <div class="box-body">
              ...
              <div class="box">
               ...
               <?php
                ...
                $itemUsuario = "id";
                $valorUsuario = $venta["id_comprador"];

                $vendedor = ControladorUsuarios::ctrMostrarUsuarios($itemUsuario, $valorUsuario);

                $itemCliente = "id";
                $valorCliente = $venta["id_proveedor"];

                $cliente = ControladorProveedores::ctrMostrarProveedores($itemCliente, $valorCliente);
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" id="nuevoComprobante" name="nuevoComprobante" value="<?php echo $venta["referencia"]; ?>"equired>

              </div>

            </div>

<!--                  <input type="hidden"  id="nuevoNFC" name="nuevoNFC" value="<?php echo $venta["ncf"]; ?>" readonly>
 -->
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="editarNFC" name="editarNFC" value="<?php echo $venta["ncf"]; ?>" required >
              ...
              <input type="text" class="form-control nuevoPrecioProducto" precioReal="'.$respuesta["precio_venta"].'" name="nuevoPrecioProducto" value="'.$value["total"].'" readonly required>
               ...
               ?>
                ...
                <button type="button" class="btn btn-default hidden-lg btnAgregarProducto1">Agregar producto</button>
